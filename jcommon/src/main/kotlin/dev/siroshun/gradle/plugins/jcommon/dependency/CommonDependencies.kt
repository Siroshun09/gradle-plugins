...
class CommonDependencies(delegate: DependencyHandler) : DependencyHandler by delegate {
    ...
    fun CommonDependencies.api(dependencyNotation: Any) {
    ...
    fun CommonDependencies.implementation(dependencyNotation: Any) {
    ...
    fun CommonDependencies.runtimeOnly(dependencyNotation: Any) {
        add(JavaPlugin.RUNTIME_ONLY_CONFIGURATION_NAME, dependencyNotation)
    }
    ...
    fun CommonDependencies.testCompileOnly(dependencyNotation: Any) {
        add(JavaPlugin.TEST_COMPILE_ONLY_CONFIGURATION_NAME, dependencyNotation)
    }
    ...
    fun CommonDependencies.testImplementation(dependencyNotation: Any) {
        add(JavaPlugin.TEST_IMPLEMENTATION_CONFIGURATION_NAME, dependencyNotation)
    }
    ...
    fun CommonDependencies.testRuntimeOnly(dependencyNotation: Any) {
        add(JavaPlugin.TEST_RUNTIME_ONLY_CONFIGURATION_NAME, dependencyNotation)
    }
